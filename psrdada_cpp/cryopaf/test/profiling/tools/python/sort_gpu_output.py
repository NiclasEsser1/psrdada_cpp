...
if __name__=="__main__":
    ...
    parser.add_argument('--file_gpu', '-gpu', action="store", default="gpu_result.txt", dest="gpu")
    parser.add_argument('--file_cpu', '-cpu', action="store", default="cpu_result.txt", dest="cpu")
    ...
    write_list_to_file(gpu_lines, "test.txt")
