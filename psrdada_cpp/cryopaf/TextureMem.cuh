...
#ifndef TEXTUREMEM_H_
#define TEXTUREMEM_H_
...
class TextureMem {
public:
	TextureMem(std::size_t width, std::size_t height=1, std::size_t depth=1, int dev_id = 0);
	TextureMem(cudaExtent volume);
	~TextureMem();
...
template class TextureMem<__half2>;
template class TextureMem<float2>;
...
#include "psrdada_cpp/cryopaf/src/TextureMem.cu"
